                        ...
                        <div class="card pb-3 px-4">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="table-responsive text-nowrap">
                                    <div class="pb-3 pt-4">
                                        <a href="<?= site_url('Tambah_Tindakan/add') ?>">
                                            <button class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                                ...
                                                <span class="d-none d-sm-inline-block">Tambah Tindakan</span>
                                            </button>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <table id="pegawai" class="table table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php
                                    $no = 1;
                                    foreach ($listtindakan->result() as $tindakan) {
                                    ?>
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?php echo site_url('Tambah_Tindakan/edit/' . $tindakan->id_tindakan); ?>">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <a class="dropdown-item" href="<?php echo site_url('Tambah_Tindakan/delete/' . $tindakan->id_tindakan); ?>">
