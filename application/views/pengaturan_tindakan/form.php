                ...
                <div class="card-body">
                  <form class="form-horizontal" role="form" action="<?php echo $action; ?>" method="POST">
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="kategori_tindakan" placeholder="Masukkan Kategori Tindakan . . ." autocomplete="off" value="<?php if (isset($kategori_tindakan)) { echo $kategori_tindakan; } ?>">
                      </div>
                    </div>
