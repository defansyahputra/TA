                    ...
                    <div class="row">
                        ...
                        <div class="card pb-3 px-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <h4 class="card-header fw-bold px-1 pt-3 pb-3">Pengaturan Klinik</h4>
                                <div class="table-responsive text-nowrap">
                                    <div class="pb-3 pt-4">
                                        <a href="<?= site_url('Pengaturan_Klinik/add') ?>">
                                            <button class="btn btn-outline-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                                                ...
                                                <span class="d-none d-sm-inline-block">Tambah Klinik</span>
                                            </button>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <table id="pegawai" class="table table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <?php
                                    $no = 1;
                                    foreach ($listklinik->result() as $klinik) {
                                    ?>
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="<?php echo site_url('Pengaturan_klinik/edit/' . $klinik->id_klinik); ?>">
                                                            <i class="bx bx-edit-alt me-1"></i> Edit
                                                        </a>
                                                        <a class="dropdown-item" href="<?php echo site_url('Pengaturan_klinik/delete/' . $klinik->id_klinik); ?>">
