            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h3 class="mb-4 fw-bold">Klinik Lembang</h3>
                        <div class="row">
    ...
    <script>
        $(document).ready(function() {
            function updateTotalIncome(startDate, endDate, category) {
                $.ajax({
                    url: "<?php echo site_url('Klinik/Klinik_Lembang/getTotalIncomeByDateRange'); ?>",
                    type: "GET",
                    data: {
                        startDate: startDate,
                        endDate: endDate,
            ...
            function updateChartData() {
                $.ajax({
                    url: "<?php echo site_url('Klinik/Klinik_Lembang/chartData'); ?>",
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
